    ...
    svr.Get("/api/v1/communities",
        [](const httplib::Request& /*req*/, httplib::Response& res) {
            ...
            try {
                ...
                ResponseHelper::fail(res, 500, std::string("服务器内部错误: ") + e.what());
            }
        });
